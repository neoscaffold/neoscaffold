/*
  - CHANGES:
    - changed font family everywhere to "PP Mori SemiBold"
    - NODE_TITLE_COLOR: '#747474',
    - NODE_SELECTED_TITLE_COLOR: '#F85E25',
    - NODE_TEXT_COLOR: '#747474',
    - NODE_DEFAULT_COLOR: '#B8D982',
    - NODE_DEFAULT_BGCOLOR: '#B8D982',
    - LINK_COLOR: '#B8D982',
*/
...
*/
  ...
  function LGraphCanvas(canvas, graph, options) {
    ...
    this.title_text_font = '' + LiteGraph.NODE_TEXT_SIZE + 'px "PP Mori SemiBold"';
    this.inner_text_font = 'normal ' + LiteGraph.NODE_SUBTEXT_SIZE + 'px "PP Mori SemiBold"';
...
*/
  ...
  LGraphCanvas.prototype.drawSubgraphPanelLeft = function (
    ...
    ctx.fillStyle = '#888';
    ctx.font = '14px "PP Mori SemiBold"';
    ctx.textAlign = 'left';
  ...
  LGraphCanvas.prototype.drawButton = function (
    ...
    if (text != null) {
      if (text.constructor == String) {
        ...
        ctx.font = ((h * 0.65) | 0) + 'px "PP Mori SemiBold"';
  ...
  LGraphCanvas.prototype.renderInfo = function (ctx, x, y) {
    ...
    ctx.font = '10px "PP Mori SemiBold"';
    ctx.fillStyle = '#888';
    ctx.textAlign = 'left';
    if (this.graph) {
  ...
  LGraphCanvas.prototype.drawBackCanvas = function () {
    ...
    if (this._graph_stack && this._graph_stack.length) {
      ...
      ctx.lineWidth = 1;
      ctx.font = '40px "PP Mori SemiBold"';
      ctx.textAlign = 'center';
    ...
    for (var i = 0; i < widgets.length; ++i) {
      ...
      switch (w.type) {
        ...
        case 'toggle':
          ...
          ctx.fillStyle = w.value ? '#89A' : '#191919';
          ctx.beginPath();
          ctx.arc(
  ...
  LGraphCanvas.prototype.drawGroups = function (canvas, ctx) {
    ...
    for (var i = 0; i < groups.length; ++i) {
      ...
      ctx.font = font_size + 'px "PP Mori SemiBold"';
      ctx.textAlign = 'left';
